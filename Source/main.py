...
if __name__ == "__main__":
 ...
 #   NewDetector.showLinesImage()
 #   print(len(NewDetector.lines))
 #   NewImage = ImReader("../Resources/medium/m10.jpg")
 #   NewDetector = LineDetector(NewImage)
 #   NewDetector.showRotatedImage()
 #   NewDetector.showLinesImage()
 #   print(len(NewDetector.lines))
 #   NewImage = ImReader("../Resources/medium/m12.jpg")
 #   NewDetector = LineDetector(NewImage)
 #   NewDetector.showRotatedImage()
 #   NewDetector.showLinesImage()
 #   print(len(NewDetector.lines))
 #   NewImage = ImReader("../Resources/medium/m13.jpg")
 #   NewDetector = LineDetector(NewImage)
 #   NewDetector.showRotatedImage()
 #   NewDetector.showLinesImage()
 #   print(len(NewDetector.lines))
 #   NewImage = ImReader("../Resources/medium/m14.jpg")
 #   NewDetector = LineDetector(NewImage)
 #   NewDetector.showRotatedImage()
 #   NewDetector.showLinesImage()
 #   print(len(NewDetector.lines))
 #   NewImage = ImReader("../Resources/medium/m15.jpg")
 #   NewDetector = LineDetector(NewImage)
 #   NewDetector.showRotatedImage()
 #   NewDetector.showLinesImage()
 #   print(len(NewDetector.lines))